...
== Description ==
WCMp now supports the concept of One product Multiple sellers. When enabled by admin, vendors can use the details of an existing product to create their own product.
...
== Changelog ==
= 2.3.6 =
* Added: Beta version for one product multiple seller available over [GitHub repository](https://github.com/dualcube/WC-Marketplace-2.3.7-Beta) 
...
* Fixed: Payment histry showing garbage data issue has been fixed.
