...
<div class="wcmp_side_menu">
	...
	<div class="wcmp_main_menu">
		<ul>
			...
			<li class="hasmenu"><a href="#" <?php if(in_array($selected_item, array('coupon', 'vendor_seo'))) {  echo 'class="active"'; } ?> ><span class="icon_stand ic4"> </span> <span class="writtings"><?php _e( 'Promote', $WCMp->text_domain ); ?></span></a>
				<ul class="submenu" <?php if($selected_item != "coupon" && $selected_item != "vendor_seo") { ?> style="display:none;" <?php } ?>>
					...
					<?php }?>
					<?php do_action('wcmp_promote_settings_sub_menu',$selected_item); ?>
				</ul>
			</li>
			<?php }?>
			<li class="hasmenu"><a <?php if($selected_item == "vendor_report") { echo 'class="active"'; } ?> href="#"><span class="icon_stand ic5"> </span> <span class="writtings"><?php _e( 'Stats/Reports', $WCMp->text_domain ); ?></span></a>
				<ul class="submenu" <?php if($selected_item != "vendor_report") { ?> style="display:none;" <?php } ?>>
					...
					<?php do_action('wcmp_report_settings_sub_menu',$selected_item); ?>
				</ul>
			</li>
